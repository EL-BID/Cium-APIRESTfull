...
/**
* Controlador Lugar de verificación
* 
* @package    CIUM API
...
* @created    2015-07-20
*
* Controlador `Lugar de verificación`: Manejo del catálogo de los lugares de verificación para los criterios de un indicador
*
*/
class LugarVerificacionController extends Controller {
    ...
    {
        $this->middleware('permisos:GET.4C75676172|POST.27167657C4|PUT.27167657C4|DELETE.27167657C4');
    }
	/**
